        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12">
          ...
          <div className="md:col-span-2 flex flex-col justify-center">
            ...
            <p className="text-slate-400 mb-8 leading-relaxed">
              Get ready to book trusted professionals and get services done. Sign in to your account to continue.
            </p>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm">Quick booking process</span>
              </div>
              <div className="flex items-center gap-3">
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-xl font-bold text-base text-slate-950 bg-gradient-to-r from-cyan-400 to-emerald-400 shadow-lg shadow-cyan-500/30 hover:shadow-2xl hover:shadow-cyan-500/50 transition disabled:opacity-60 disabled:cursor-not-allowed"
            >
